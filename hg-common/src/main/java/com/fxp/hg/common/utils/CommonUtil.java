...
public class CommonUtil {
    ...
    public static JSONObject successJson(Object info) {
        ...
        resultJson.put("code", ResultCode.SUCCESS.getCode());
        resultJson.put("msg", ResultCode.SUCCESS.getMessage());
    ...
    public static JSONObject errorJson(ResultCode resultCode) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("code", resultCode.getCode());
        resultJson.put("msg", resultCode.getMessage());
