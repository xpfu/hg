...
import com.fxp.hg.common.exception.CommonJsonException;
...
public class GlobalExceptionHandler {
    ...
    public JSONObject defaultErrorHandler(HttpServletRequest req, Exception e) {
        ...
        jsonObject.put("msg", ResultCode.E_400.getMessage());
    ...
    public JSONObject httpRequestMethodHandler() {
        return CommonUtil.errorJson(ResultCode.E_500);
    }
    ...
    public JSONObject unauthorizedExceptionHandler() {
        return CommonUtil.errorJson(ResultCode.E_502);
    }
    ...
    public JSONObject unauthenticatedException() {
        return CommonUtil.errorJson(ResultCode.E_20011);
    }
}
